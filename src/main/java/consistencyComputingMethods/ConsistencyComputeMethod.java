...
//	protected double consistencyIndex;
	...
	public double getConsistencyRatio(double consistencyIndex, int matrixSize){
		consistencyRatio = consistencyIndex / randomIndex[matrixSize];
		System.out.println("consistencyRatio without abs: " + consistencyRatio);
		return Math.abs(consistencyRatio);
	}

	public static MaximumEigenvalue getMaximumEigenvalueMethod() {
